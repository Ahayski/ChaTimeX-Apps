...
export default function MyProfile() {
  ...
  return (
    ...
    >
      <Box m={4}>
        <Card bg={"#EEEDED"} borderRadius="lg">
          <Box m={4} color="#081c15">
      ...
      <Box m={4}>
        ...
        >
          ...
          {filteredUsers.map((user: any) => (
            <Box px={4} key={user.id} display="flex" position="relative">
              <Box
              ...
              <Box mt={3} textAlign={"center"}>
                {!isFollowMap[user.id!] ? (
                  <Button
                    ...
                    textColor={"white"}
                    h={7}
                    _hover={{ bg: "#081c15", textColor: "green" }}
        ...
        {/* footer */}{" "}
        <Card bg={"#EEEDED"} boxShadow="0px 4px 6px rgba(0, 0, 0, 0.5)" mt="5">
          <CardBody
            mx={"auto"}
            display={"flex"}
            alignItems={"center"}
          ...
          >
            <Text fontSize={"12px"} fontWeight={"bold"}>
              Developed by Febryan De Gheans
            </Text>
            <AiFillGithub />
            <AiFillLinkedin />
            <AiFillFacebook />
